...
(function() {
	...
	// "On Visible" animations.
		...
		onvisible.add('#text01', { style: 'blur-in', speed: 1000, intensity: 5, delay: 500, replay: false });
		onvisible.add('#text07', { style: 'fade-in', speed: 1000, intensity: 5, delay: 875, replay: false });
		onvisible.add('#text06', { style: 'fade-in', speed: 1000, intensity: 5, delay: 1250, replay: false });
		onvisible.add('#list01', { style: 'fade-in', speed: 1000, intensity: 5, delay: 1625, stagger: 750, replay: false });
		onvisible.add('#text04', { style: 'fade-in', speed: 1000, intensity: 5, delay: 4250, replay: false });
